# plot1.R generates a histogram of the frequency of readings 
# for each global active power value
...
# Create the plot
with(twoDaysData, hist(Global_active_power, col="red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)"))
